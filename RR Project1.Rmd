...
```{r histogram and mean and median, warning=FALSE}
...
We also report the time interval in which the maximum steps have been taken. 
```{r}
...
ggplot(data = interval_means) +
  geom_line(aes(x = Interval, y = Weekdays_Mean) , col = "blue") +
  geom_line(aes(x = Interval, y = Weekends_Mean)) +
  labs(
       title = "Weekdays and Weekends Average Number of Steps",
       x = "Time Interval ",
       y = "Steps",
       )
